$(() => {
  ...
  $("#associationbutton").click(function () {
      $('html,body').animate({
          scrollTop: $("#items").offset().top},'slow');
  });
  ...
  $("#companybutton").on("click", () => {
    $.ajax({
      ...
      success: function (data) {
        ...
        var htmlString21 = "";
          htmlString21 += "<p>This university is located at " + data.results[0].formatted_address + ". It is rated a " + data.results[0].rating + " out of 5 by other travellers.</p>"
        ...
        var htmlString31 = "";
          htmlString31 += "<p>This university is located at " + data.results[1].formatted_address + ". It is rated a " + data.results[1].rating + " out of 5 by other travellers.</p>"
        ...
        var htmlString41 = "";
          htmlString41 += "<p>This university is located at " + data.results[2].formatted_address + ". It is rated a " + data.results[2].rating + " out of 5 by other travellers.</p>"
        ...
        var htmlString51 = "";
          htmlString51 += "<p>This university is located at " + data.results[3].formatted_address + ". It is rated a " + data.results[3].rating + " out of 5 by other travellers.</p>"
    ...
    $("#cafebutton").on("click", () => {
      $.ajax({
        ...
        data: {
          query: document.getElementById("autocomplete").value,
          key: "AIzaSyB-LDq2UPeSay8YufFF3Y-Mi93HVQQw1aU",
          ID: "ChIJWW2G4CAzxEcRHs4WRl-65dg",
        },
        success: function (data) {
          document.getElementById("titlebutton").innerHTML = "";
          var header = document.getElementById("titlebutton");
